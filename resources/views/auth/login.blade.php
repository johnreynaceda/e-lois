<x-guest-layout>
  ...
  <div class="bg-gradient-to-tr from-gray-400 via-white to-gray-400 h-screen py-10 lg:p-20 lg:px-80 flex w-full">
    <div class="absolute bottom-5 right-0">
      <svg class="h-14 opacity-50" viewBox="0 0 128 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="bg-white relative p-3 w-full lg:rounded-3xl flex">
      <div class="bg-gradient-to-l from-gray-500 to-gray-700 hidden lg:block shadow-lg w-96 h-full p-5 rounded-xl">
        <div class="flex space-x-1 items-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 fill-white">
          ...
          <h1 class="font-bold text-lg text-white font-rubik">e-LOIS</h1>
        </div>
        <div class="mt-64">
          <h1 class="font-bold font-rubik text-3xl text-white uppercase"> We Specialise in all Aspects of Laws</h1>
          <p class="mt-3  text-sm font-rubik text-gray-50 sm:mt-5 ">We <strong class="text-sky-300">never
              sleep</strong> till our
            client <strong class="text-sky-300">get justice</strong>.</p>
        </div>
      </div>
      <div class="flex-1 px-4 lg:px-14 py-14">
        <div class="font-rubik">
          <h1 class="text-2xl font-black text-gray-600">Login</h1>
          <p class="text-sm text-gray-500">Welcome back, please login to your account.</p>
          <div class="mt-10">
            <x-jet-validation-errors class="mb-4" />
            <form method="POST" action="{{ route('login') }}">
              @csrf
              <div>
                <label for="account-number" class="block text-sm text-gray-700">Email</label>
                <div class="relative mt-1 rounded-md shadow-sm">
                  <input id="email" type="email" name="email" :value="old('email')" required autofocus
                    class="block w-full rounded-md border-gray-300 pr-10 focus:border-gray-500 focus:ring-gray-500"
                    placeholder="">
              ...
              <div class="mt-5">
                <label for="account-number" class="block text-sm text-gray-700">Password</label>
                <div class="relative mt-1 rounded-md shadow-sm">
              ...
              <div class="mt-8 flex justify-between w-full items-center">
                ...
                <div>
                  <x-button type="submit" dark md label="SIGN IN" right-icon="arrow-narrow-right" />
              ...
              <h1 class="mt-2 text-sm text-gray-700">Don't have an account? <a href="{{ route('register') }}"
                  class="text-sky-400 hover:text-gray-500">Register</a></h1>
            </form>
          </div>
        </div>
      </div>
